...
echo -e ""
 ...
 echo -e  " ${GREEN} ║\e[0m02. Panel Wireguard   $bl   "
 echo -e  " ${GREEN} ║\e[0m03. Panel L2tp & PPTP $gl   "
 echo -e  " ${GREEN} ║\e[0m04. Panel Vmess & Vless $bl  "
 echo -e  " ${GREEN} ║\e[0m05. Panel Trojan  $bl    "
 echo -e  " ${GREEN} ║\e[0m06. Add Subdomain For Vps $gl  "
 echo -e  " ${GREEN} ║\e[0m07. Renew Certificate V2ray $bl   "
 echo -e  " ${GREEN} ║\e[0m08. Change Port All Acount  $bl  "
 echo -e  " ${GREEN} ║\e[0m09. Cek Status Layanan  $gl   "
 echo -e  " ${GREEN} ║\e[0m10. Webmin Menu $gl  "
 echo -e  " ${GREEN} ║\e[0m11. Cek Bandwith Harian  $gl  "
 echo -e  " ${GREEN} ║\e[0m12. Reboot Vps $gl  "
